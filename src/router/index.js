...
>>>>>>> 08835ad79b70c5f9011ce36729204b2f3cc1b7e3
    ...
    {
        path: '/knowledgeSupermarket',
        component: Layout,
        redirect: '/sms/coupon1',
        name: 'knowledgeSupermarket',
        meta: {
            title: '知识超市',
            icon: 'sms'
        },
        children: [{
            path: 'showList',
            name: 'knowledgeSupermarketList',
            component: () => import('@/views/knowledgeSupermarket/list'),
            meta: {
                title: '知识超市列表',
                icon: 'sms-flash'
            }
        },
        {
            path: 'addList',
            name: 'addList',
            component: () => import('@/views/knowledgeSupermarket/addList'),
            meta: {
                title: '添加/修改课程',
                icon: 'sms-flash'
            }
